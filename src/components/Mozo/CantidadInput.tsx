...
export default function CantidadInput({ value, onChange }: CantidadInputProps) {
  ...
  return (
    <div className="inline-flex shrink-0 items-center rounded-lg border border-cacao-200 bg-white">
      <button
        type="button"
        className="flex h-9 w-9 items-center justify-center text-xl leading-none text-cacao-500 active:bg-cacao-100"
        onClick={() => set(value - 1)}
